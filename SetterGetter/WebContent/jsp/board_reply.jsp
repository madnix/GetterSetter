...
<!-- =============================== board_comment 시작 =============================== -->
	...
	<div id="side_line"></div>
	 ...
	 <!-- ===========   board_info 시작   ============= -->
<form method="post" name="f" action="board_reply.do?no=${no }&pageNum=${pageNum}" onsubmit="return board_edit()" >
	 <div id="board_Write_Wrap">

		<input type="hidden" name="reply_select_no" value="${board_cont.reply_select_no }">	 
		<input type="hidden" name="reply_level" value="${board_cont.reply_level }">	 
		<input type="hidden" name="reply_seq" value="${board_cont.reply_seq }">	 
		
	  <table>
		<tr>
			<td class="left_box">제목&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td colspan="3"><input type="text" name="title" id="title" size="30" class="right_title_box" value="[re]${board_cont.board_title }"></td>
		</tr>
	  </table>
	  ...
	  <table>
		<tr>
			...
			<td><input type="text" name="name" id="name" size="15" class="right_box" value="${replyInfo.name }"></td>
		</tr>
	  </table>
		...
		<tr>
			<td class="left_box">이메일&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td class="right_check_box">
					<input type="text" name="email1" id="email1" size="20" value="${replyInfo.email1 }">@
					<input type="text" name="email2" id="email2" size="20" value="${replyInfo.email2 }">
