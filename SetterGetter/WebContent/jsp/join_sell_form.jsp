...
<script type="text/javascript" src="./js/join_sell_form.js" ></script>
<link rel="stylesheet" type="text/css" href="./css/join_sell_form.css" />
...
<form method="post" name="f" action="join_sell_form.do" onsubmit="return join_check()">
		...
		<input type="hidden" name="section" value="1" />
			<table>
				<tr>
					...
					<td colspan="3"><input name="id" id="id" readonly onclick="id_search()" class="info_box" />
					<input type="button" value="아이디중복체크" onclick="id_check()" class="info_box" />		
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<input type="password" name="pwd" id="pwd" class="info_box" />(영문소문자/숫자, 4~16자)</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3"><input type="password" name="pwd_check" id="pwd_check" class="info_box" /></td>
				</tr>
				...
				<tr>
					...
					<td>
						<input name="zip1" id="zip1" class="info_box4" /> - <input name="zip2" id="zip2" class="info_box4" />						
				...
				<tr>
					...
					</select>-<input name="tel2" id="tel2" class="info_box4" />-<input name="tel3" id="tel3" class="info_box4" /></td>
				</tr>
		...
		<div id="sell_info">
			<table>
				<tr>
					...
					<td colspan="3">
						<input name="cor" id="cor" class="info_box" />	
					</td>		
				</tr>
				...
				<tr>
					...
					<td colspan="3">
						<input name="cor_name" id="cor_name" class="info_box" />	
					</td>		
				</tr>
				...
				<tr>
					...
					<td colspan="3">
						<input name="cor_number" id="cor_number" class="info_box" />	
					</td>		
				</tr>
				...
				<tr>
					...
					<td>
						<input name="cor_zip1" id="cor_zip1" maxlength="3" class="info_box4" /> - <input name="cor_zip2" id="cor_zip2" maxlength="3" class="info_box4" />						
						<input type="button" value="우편번호" onclick="post_check(2)" class="info_box" /></td>
				</tr>
				<tr><td colspan="3"><input name="cor_addr1" id="cor_addr1" class="info_box2" /></td></tr>
				<tr><td colspan="3"><input name="cor_addr2" id="cor_addr2" class="info_box2" /></td></tr>
				...
				<tr>
					...
					<td colspan="3"><select name="cor_tel1" id="cor_tel1" class="info_box5" >
						...
						<option value="062">062</option>	<option value="063">063</option>		
						<option value="064">064</option>
					</select> - <input name="cor_tel2" id="cor_tel2" maxlength="4" class="info_box4" /> - <input name="cor_tel3" id="cor_tel3" maxlength="4" class="info_box4"/></td>
				</tr>
				...
				<tr>
					...
					<td colspan="3"><select name="cor_fax1" id="cor_fax1" class="info_box5" >
						...
						<option value="062">062</option>	<option value="063">063</option>		
						<option value="064">064</option>
					</select> - <input name="cor_fax2" id="cor_fax2" maxlength="4" class="info_box4" /> - <input name="cor_fax3" id="cor_fax3" maxlength="4" class="info_box4"/></td>
				</tr>
				...
				<tr>
					...
					<td colspan="3"><input name="cor_mail1" id="cor_mail1" class="info_box" /> @ <input name="cor_mail2" id="cor_mail2" class="info_box" />
